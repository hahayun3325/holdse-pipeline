...
new_misc = np.load('logs/0cea9fc97/misc/000056000.npy', allow_pickle=True).item()
...
np.save('/home/fredcui/Projects/holdse/code/logs/0cea9fc97_final_hybrid/misc/000056000.npy',
        hybrid)
