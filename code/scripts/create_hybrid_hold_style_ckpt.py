...
new_misc = np.load('logs/c7b4603c9/misc/000056000.npy', allow_pickle=True).item()
...
np.save('/home/fredcui/Projects/holdse/code/logs/c7b4603c9_final_hybrid/misc/000056000.npy',
        hybrid)
