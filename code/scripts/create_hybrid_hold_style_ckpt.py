...
new_misc = np.load('logs/030726a4f/misc/000059500.npy', allow_pickle=True).item()
...
np.save('/home/fredcui/Projects/holdse/code/logs/030726a4f_000060000_hybrid/misc/000059500.npy',
        hybrid)
