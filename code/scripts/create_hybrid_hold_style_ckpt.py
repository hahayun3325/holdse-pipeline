...
new_misc = np.load('logs/694416964/misc/000080000.npy', allow_pickle=True).item()
...
np.save('/home/fredcui/Projects/hold-master/code/logs/694416964/misc/000080000.npy',
        hybrid)
