...
new_misc = np.load('logs/aa59e9bb3/misc/000001500.npy', allow_pickle=True).item()
...
np.save('/home/fredcui/Projects/holdse/code/logs/aa59e9bb3_000001500_hybrid/misc/000001500.npy',
        hybrid)
