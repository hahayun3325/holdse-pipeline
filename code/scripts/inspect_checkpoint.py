...
# Run comparison
inspect_checkpoint('logs/7d4651137_000001000/checkpoints/last.ckpt', 'HOLDSE step 20000')
inspect_checkpoint('logs/7d4651137_000005000/checkpoints/last.ckpt', 'HOLDSE step 20000')
