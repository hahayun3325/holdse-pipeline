...
#STAGE3_CONFIG="confs/stage3_hold_MC1_ho3d_sds_from_official_SDS_only.yaml"
STAGE3_CONFIG="confs/stage3_hold_MC1_ho3d_sds_from_official_object_geom_only.yaml"
...
# ./scripts/train_MC1_stage3_from_official.sh 2>&1 | tee logs/stage3_1to30_hold_MC1_ho3d_official_$(date +%Y%m%d_%H%M%S).log
